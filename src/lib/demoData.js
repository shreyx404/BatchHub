...
const DEMO_POSTS = [
  ...
  {
    id: 'post-13',
    title: 'DCN Wireshark Lab — Packet Capture Analysis',
    content: `Capture and analyse HTTP, DNS, and TCP packets using Wireshark. Submit annotated screenshots with protocol field explanations.`,
    type: 'lab',
    subject_id: 'subj-dcn',
    is_pinned: false,
    status: 'archived',
    due_date: getRelativeDate(-12),
    tags: ['dcn', 'lab', 'wireshark', 'archived'],
    links: [
      { label: 'Wireshark Lab Handout', url: 'https://example.com/wireshark-lab.pdf' },
    ],
    created_at: getRelativeDate(-20),
    updated_at: getRelativeDate(-12),
    subjects: DEMO_SUBJECTS[3],
  },
  {
    id: 'post-14',
    title: 'Notice: Library Access Hours Extended During Exams',
    content: `The central library will remain open until 11 PM during the mid-semester examination period (Sep 1–Sep 10). Student ID mandatory for after-hours entry.`,
    type: 'notice',
    subject_id: null,
    is_pinned: false,
    status: 'archived',
    due_date: getRelativeDate(-10),
    tags: ['notice', 'library', 'exams', 'archived'],
    links: [],
  ...
  {
    id: 'post-15',
    title: 'BIoT Arduino Workshop — Sensor Calibration Basics',
    content: `Hands-on workshop covering DHT11, MQ-135, and ultrasonic sensor calibration with Arduino Uno. Bring your kit.`,
    type: 'deadline',
    subject_id: 'subj-biot',
    is_pinned: false,
    status: 'archived',
    due_date: getRelativeDate(-15),
    tags: ['biot', 'workshop', 'arduino', 'archived'],
    links: [
      { label: 'Workshop Slides', url: 'https://example.com/biot-workshop.pdf' },
      { label: 'Arduino Starter Code (GitHub)', url: 'https://github.com' },
    ],
    created_at: getRelativeDate(-22),
    updated_at: getRelativeDate(-15),
    subjects: DEMO_SUBJECTS[4],
  },
];
