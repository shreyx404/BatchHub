...
const DEMO_NOTES = [
  ...
  {
    id: 'note-1b',
    title: 'Application Layer Protocols (HTTP, DNS, DHCP)',
    subtitle: 'Unit IV — Data Communication & Networking',
    subject_id: 'subj-dcn',
    url: 'https://shreyx404.github.io/batch-notes/dcn-unit4-application.html',
    tags: ['dcn', 'http', 'dns', 'application-layer'],
    sort_order: 1,
    created_at: getRelativeDate(-4),
    updated_at: getRelativeDate(-4),
    subjects: DEMO_SUBJECTS[3],
  ...
  {
    id: 'note-1c',
    title: 'TCP/IP Architecture & Subnetting',
    subtitle: 'Unit III — Data Communication & Networking',
    subject_id: 'subj-dcn',
    url: 'https://shreyx404.github.io/batch-notes/dcn-unit3-tcpip.html',
  ...
  },
  {
    ...
    subtitle: 'Unit IV — Trees and Hierarchical Structures',
    subject_id: 'subj-fds',
    url: 'https://shreyx404.github.io/batch-notes/fds-unit4-trees.html',
  ...
  },
  {
    ...
    subtitle: 'Unit I — Introduction to Algorithms',
    subject_id: 'subj-fds',
    url: 'https://shreyx404.github.io/batch-notes/fds-unit1-complexity.html',
  ...
  {
    id: 'note-3b',
    title: 'Actuators & Microcontroller Interfacing',
    subtitle: 'Unit II — Hardware Interfaces',
    subject_id: 'subj-biot',
    url: 'https://shreyx404.github.io/batch-notes/biot-unit2-hardware.html',
    tags: ['sensors', 'actuators', 'hardware'],
    sort_order: 7,
    created_at: getRelativeDate(-2),
    updated_at: getRelativeDate(-2),
    subjects: DEMO_SUBJECTS[4],
