...
export default function AdminSidebar({ isOpen, onClose, onLogout }) {
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 z-50 h-dvh w-64 bg-[var(--color-surface)] border-r border-[var(--color-border)] flex flex-col transform transition-transform duration-300 lg:relative lg:translate-x-0
