...
└── <App>                          // Route definitions (lazy routes + Suspense fallback)
    ...
    │   ├── <CalendarAgendaView>   // Chronological timeline view grouped by date with sticky date headers and contained independent scroll (active upcoming deadlines only) [Agenda View]
